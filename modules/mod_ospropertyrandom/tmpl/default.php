...
?>
	...
	?>	
		<div class="element_property" style="width:<?php echo $element_width?>px;<?php echo $float?>;height:<?php echo $element_height?>px;overflow:hidden;">
			...
			<div class="description_property1">					
				...
				if($sold_property_types != ""){
					...
					if(in_array($property->pro_type, $sold_property_typesArr)){
						$show_sold = 1;
					}
				}
				if(($property->isSold == 1) and ($show_sold == 1)){
					?>
		...
		?>
		<div class="element_property1" style="width:<?php echo $element_width?>px;<?php echo $float?>;border:1px solid <?php echo $color; ?> !important;height:<?php echo $element_height?>px;">
			<?php
			if($show_photo == 1){
			?>
