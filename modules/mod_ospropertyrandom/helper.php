...
class modOSpropertyramdomHelper extends JObject
{
	...
	function getProperty()
	{
		...
		// number property is shown
		$number_property = $this->params->get('number_property', 5);
		...
		//if ($filter_category > 0){
			...
			//$where[]     = " p.id in (Select pid from #__osrs_property_categories where category_id IN ($catids)) ";
			//$check_search = false;
		//}
