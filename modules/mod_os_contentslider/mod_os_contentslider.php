...
error_reporting(0);
require_once JPATH_SITE.'/modules/mod_os_contentslider/helpers/helper.php';

//Get list content
$list = modOSContentSliderHelper::getList( $params, $module );
//var_dump($list);
...
$preloadImg = JURI::root().'/modules/mod_os_contentslider/tmpl/images/loading.gif';
...
modOSContentSliderHelper::fetchHead( $params );
