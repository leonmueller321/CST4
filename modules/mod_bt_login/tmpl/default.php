...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			...
			?>
			<span id="btl-panel-registration" class="<?php echo $effect;?>"><i class="fa fa-pencil"></i> <?php echo JText::_('JREGISTER');?></span>
			<?php }
			} ?>
	...
	<div id="btl-content">
		...
		<div id="btl-content-profile" class="btl-content-block">
			...
			<div class="btl-buttonsubmit">
				<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="logoutForm">
					<button name="Submit" class="btl-buttonsubmit btn btn-primary" onclick="document.logoutForm.submit();"><?php echo JText::_('JLOGOUT'); ?></button>
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
				...
				<?php endif; ?>
				<div class="btl-buttonsubmit">
					<input type="submit" name="Submit" class="btl-buttonsubmit btn btn-primary" onclick="return loginAjax()" value="<?php echo JText::_('JLOGIN') ?>" /> 
					<input type="hidden" name="option" value="com_users" />
