						...
						<div class="span12">
							...
							<div class="span4">
								<div class="control-group">
									...
									<div class="controls">
										<div class="row-fluid">
											<div class="span11" id="locator_price">
												<?php
        ...
        <div class="leadFormWrap">
            <form method="POST" action="<?php echo JURI::root()?>index.php?option=com_osproperty&task=property_requestmoredetails&Itemid=<?php echo $itemid?>" name="requestdetails_form" id="requestdetails_form" class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="input-large" type="text" id="your_phone" name="your_phone" maxlength="30" placeholder="<?php echo JText::_('OS_PHONE')?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">
    ...
    public static function requestMoreDetailsTop($row,$itemid,$classname='input-medium'){
        ...
        <div class="leadFormWrap">
            <form method="POST" action="<?php echo JURI::root()?>index.php?option=com_osproperty&task=property_requestmoredetails&Itemid=<?php echo $itemid?>" name="requestdetails_form" id="requestdetails_form">
                ...
                <input class="<?php echo $classname;?>" type="text" id="requestyour_name" name="requestyour_name" size="30" maxlength="30"  value="<?php echo $user->name?>" placeholder="<?php echo JText::_('OS_YOUR_NAME')?>"/>
                <input class="<?php echo $classname;?>" type="text" id="your_phone" name="your_phone" maxlength="30" placeholder="<?php echo JText::_('OS_PHONE')?>"/>
                <input class="<?php echo $classname;?>" type="text" id="requestyour_email" name="requestyour_email" size="30" maxlength="30"  value="<?php echo $user->email;?>" placeholder="<?php echo JText::_('OS_YOUR_EMAIL')?>"/>
