				...
				<div class="tab-pane" id="addpropertypanel2">
					<div class="col width-100">
						<fieldset class="fieldsetpropertydetails">
							...
							<input type="hidden" name="access" id="access" value="<?php echo ($configClass['default_access_level'] == "" ? '1' : $configClass['default_access_level']); ?>" />
													...
													<table width="100%" class="property_history_table">
														...
														<tr>
															...
															for($i=0;$i<count($tmpamenities);$i++){
																...
																?>
																<input type="checkbox" name="amenities[]" <?php echo $checked?> value="<?php echo $tmpamenities[$i]->id?>"> &nbsp; <?php echo OSPHelper::getLanguageFieldValue($tmpamenities[$i],'amenities'); //$tmpamenities[$i]->amenities;?>
																<BR />
																<?php
															}
															?>
