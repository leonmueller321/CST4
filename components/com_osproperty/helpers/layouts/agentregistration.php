	...
	<div class="span12">
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="phone" id="phone" size="20" class="input-medium" placeholder="<?php echo JText::_('OS_PHONE')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="mobile" id="mobile" size="20" class="input-medium" placeholder="<?php echo JText::_('OS_MOBILE')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="fax" id="fax" size="20" class="input-medium" placeholder="<?php echo JText::_('OS_FAX')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="yahoo" id="yahoo" size="20" class="input-medium" placeholder="<?php echo JText::_('Yahoo')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="skype" id="skype" size="20" class="input-medium" placeholder="<?php echo JText::_('Skype')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="msn" id="msn" size="20" class="input-medium" placeholder="<?php echo JText::_('Msn')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="gtalk" id="gtalk" size="20" class="input-medium" placeholder="<?php echo JText::_('Gtalk')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="facebook" id="facebook" size="20" class="input-medium" placeholder="<?php echo JText::_('Facebook')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="control-group" style="text-align:center;">
				...
				<a href="<?php echo JURI::root()?>index.php?option=com_content&view=article&id=<?php echo $configClass['agent_article_id'];?>&tmpl=component" class="osmodal" rel="{handler: 'iframe', size: {x: 600, y: 450}}" title="<?php echo JText::_('OS_TERM_AND_CONDITION');?>"><?php echo JText::_('OS_TERM_AND_CONDITION');?></a>
			</div>
			<?php 
		} 
		?>
