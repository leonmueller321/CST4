		...
		<div class="row-fluid">
			<div class="span12">
				...
				<table  width="100%" class="table table-striped">
					...
					<tr class="row0">
						<td class="compare_title" width="20%" valign="top" style="background-color:#F8F2EB;">
							<?php 
								...
								?>
									...
									?>
										<a href="<?php echo JURI::root()?>images/osproperty/properties/<?php echo $property->id;?>/<?php echo $photo->image?>" class="osmodal">
											<img src="<?php echo JURI::root()?>images/osproperty/properties/<?php echo $property->id;?>/thumb/<?php echo $photo->image?>" width="150" class="img-polaroid" />
										</a>
									<?php }else{ ?>
									...
									?>
								<?php }else{ ?>
									<img src="<?php echo JURI::root()?>components/com_osproperty/images/assets/nopropertyphoto.png" width="150" class="img-polaroid" />
								<?php
								}
								?>
							</td>
					...
					<tr class="row0"> 
						...
						for($i=0;$i<count($comparisionArr);$i++){
							...
							<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;background-color:#FFF;">
								...
								?>
								<img src="<?php echo JURI::root()?>components/com_osproperty/images/assets/stars-0.png" /> (0/5)
								<?php
							}
							?>
							</td>
