	...
	**/
	static function loadFooter($option){
		...
		<div style="width:100%;text-align:center;margin:15px;">
			<strong><a href="http://joomdonation.com/joomla-extensions/os-property-joomla-real-estate.html" target="_blank">OS Property</a></strong> Version <?php echo $version;?>, Copyright (C) 2011 - 2015 <strong><a href="http://joomdonation.com" target="_blank">Ossolution Team</a></strong>
		</div>
		<?php
	}
    /**
