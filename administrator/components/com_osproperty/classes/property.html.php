            ...
            <div class="span12">
                <div class="js-stools-container-filters hidden-phone clearfix shown">
                    <div class="js-stools-field-filter">
						...
						OSPHelper::loadAgentTypeDropdownFilter(JRequest::getInt('agent_type',-1),'chosen input-medium','onChange="javascript:document.adminForm.submit();"');
						?>
                    </div>
                    <div class="js-stools-field-filter">
        ...
        if(count($rows) > 0) {
            ...
            <table class="adminlist table table-striped">
                ...
                <tr>
                    ...
                    <th width="10%" class="hidden-phone" style="text-align:center;">
                        ...
                        <td align="center" class="hidden-phone">
                            ...
                            if (count($photo) > 0) {
                                ...
                                <a href="<?php echo JURI::root()?>images/osproperty/properties/<?php echo $row->id?>/<?php echo $photo->image?>"
                                   class="osmodal">
                                    <?php
                                    OSPHelper::showPropertyPhoto($photo->image, 'thumb', $row->id, 'width:70px;', 'img-polaroid', '');
                                    ?>
                                </a>
                            <?php
                            } else {
                                ...
                                <div class="btn-group">
                                    ...
                                    if ($row->isFeatured == 1) {
                                        ...
                                        <a class="btn btn-micro active hasTooltip"
                                           ...
                                           title="<?php echo JText::_('OS_CHANGE_FEATURED_STATUS');?>" style="color:red;">
