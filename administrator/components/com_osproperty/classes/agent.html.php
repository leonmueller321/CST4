                ...
                <div class="span6 pull-right js-stools-container-list hidden-phone hidden-tablet shown">
                    <div class="ordering-select hidden-phone">
                        <div class="js-stools-field-list">
                            <?php echo OSPHelper::loadAgentTypeDropdownFilter(JRequest::getInt('agentType',-1),'chosen input-medium','onChange="javascript:document.adminForm.submit();"');?>
                        </div>
                        <div class="js-stools-field-list">
		...
		<table width="100%" class="adminlist table table-striped">
			<thead>
				<tr>
					...
					<th width="10%" style="text-align:left;">
						<?php echo JHTML::_('grid.sort',   JText::_('OS_EMAIL'), 'a.email', @$lists['order_Dir'], @$lists['order'],'agent_list' ); ?>
					</th>
					<?php
					if($tmpl != "component"){
						?>
						...
						<th width="10%" style="text-align:center;">
							<?php echo JHTML::_('grid.sort',   JText::_('OS_APPROVED'), 'a.request_to_approval', @$lists['order_Dir'], @$lists['order'],'agent_list' ); ?>
						</th>
						<?php
						}
						?>
					...
					<td width="35%" valign="top">
						...
						<fieldset class="fieldset_web">
							...
							<table width="100%">
								...
								<tr>
									<td class="key" style="text-align:center;"><img alt="" src="<?php echo JURI::root()?>components/com_osproperty/images/assets/yahoo.jpg"> </td>
									<td width="70%"><input type="text" name="yahoo" id="yahoo" size="40" maxlength="100" value="<?php echo $row->yahoo?>" class="input-medium" placeholder="<?php echo Jtext::_('Yahoo');?>" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width="70%"><input type="text" name="msn" id="msn" size="40" maxlength="100" value="<?php echo $row->msn?>" class="input-medium" placeholder="<?php echo Jtext::_('Msn');?>"/></td>
								</tr>
								<tr>
