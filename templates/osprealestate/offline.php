...
<head>
	...
	<link href='http://fonts.googleapis.com/css?family=Raleway:300,400,800,700,500,900' rel='stylesheet' type='text/css'>
...
<body>
	...
	<div id="frame" class="outline">
		<div class="offline-page">
			...
			<div class="brand">
  				<a href="index.php" title="<?php echo htmlspecialchars($app->getCfg('sitename')); ?>"><img src="<?php echo $app->getCfg('offline_image'); ?>" alt="<?php echo htmlspecialchars($app->getCfg('sitename')); ?>" /></a>
            </div>
  		<?php endif; ?>
